...
const dummyMeals = [
  ...
  Meal(
   ...
   Meal(
    ...
    steps: [
      ...
      'Spread tomato sauce over the dough, add mozzarella cheese, and top with fresh basil leaves.',
   ...
   Meal(
    ...
    steps: [
      'Grill or cook the veggie patty according to package instructions.',
      'Slice the whole wheat bun and toast it.',
      'Assemble the burger with lettuce, tomato, onion, pickles, and condiments.',
      'Place the veggie patty in the bun and serve.',
    ],
    isGlutenFree: false,
    isVegan: true,
    isVegetarian: true,
  ...
  Meal(
    ...
    affordability: Affordability.pricey,
    complexity: Complexity.challenging,
    imageUrl:'https://source.unsplash.com/800x600/?german-food',
    duration: 180,
    ingredients: [
      '2 kg Beef Roast',
    ...
    steps: [
      'Marinate the beef roast in red wine vinegar, chopped onions, bay leaves, peppercorns, salt, and pepper for at least 24 hours.',
      'Remove the beef from the marinade and brown it in a pan.',
      'Transfer the beef to a slow cooker and add the marinade and water.',
      'Cook on low heat for 3-4 hours until the meat is tender.',
      'Serve the sauerbraten with its rich gravy.',
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: false,
